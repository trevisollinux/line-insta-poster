...
def relatorio_markdown(diagnostico: Diagnostico) -> str:
    ...
    return (
        ...
        "   - Não tem nenhum → o agendamento não chegou a virar execução. O\n"
        "     despachante de cron do GitHub cria o run horas depois da hora\n"
        "     marcada, e sob carga pode descartar a execução em vez de adiá-la.\n"
